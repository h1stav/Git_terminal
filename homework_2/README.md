...
_С помощью утилиты **xargs** вывод предыдущей команды можно передать в аргументы следующей. Чтобы найти путь к файлу используем команду **realpath**_
...
_С помощью утилиты **xargs** вывод предыдущей команды можно передать в аргументы следующей._
