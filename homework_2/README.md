...
25. _Найти строки в файлах где есть только комбинация букв **“sec”** в текущей папке_
    С этой опцией **-r**, grep будет искать все файлы в текущем (или указанном) каталоге, а также все файлы во всех подкаталогах. А для поиска только определенной комбинации букв, нужно  использовать ключ **-w**_
```
$ grep -rw sec
```
Result
